...
var _Question = __webpack_require__(163);
...
var MazeHome = function (_React$Component) {
  _inherits(MazeHome, _React$Component);
  ...
  function MazeHome() {
    ...
    _classCallCheck(this, MazeHome);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MazeHome.__proto__ || Object.getPrototypeOf(MazeHome)).call.apply(_ref, [this].concat(args))), _this), _this.state = _extends({
      questions: [],
      answers: [],
      squares: []
    }, initialState), _this.start = function () {
      _this.setState({
        isStart: true
      });

      _this.next = _this.autoNext();
    }, _this.autoNext = function () {
      return setInterval(_this.nextIndex, DELAY_NEXT);
    }, _this.nextIndex = function () {
      _this.setState({
        currentSquareIndex: _this.state.currentSquareIndex + 1
      });
    }, _this.resume = function () {
      _this.setState({
        currentQuestion: _extends({}, _this.state.currentQuestion, {
          isShow: false
        })
      });
      _this.next = _this.autoNext();
      ...
      _this.setState(_extends({}, initialState), function () {
        return _this.start();
      });
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(MazeHome, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      var _this2 = this;

      _axios2.default.get('/data').then(function (_ref2) {
        var data = _ref2.data;
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      var _state = this.state,
          ...
          currentSquareIndex = _state.currentSquareIndex,
          questions = _state.questions,
          answers = _state.answers;

      if (prevState.currentSquareIndex !== currentSquareIndex) {
        var squareIndex = squares[currentSquareIndex];
        var squareQuestions = questions.filter(function (question) {
          return question.square_index === squareIndex;
        });
        var question = squareQuestions[Math.floor(Math.random() * squareQuestions.length)];
        if (question) {
    ...
    value: function render() {
      var _state2 = this.state,
          isStart = _state2.isStart,
          questions = _state2.questions,
          answers = _state2.answers,
          squares = _state2.squares,
          currentSquareIndex = _state2.currentSquareIndex,
          currentQuestion = _state2.currentQuestion,
          isLose = _state2.isLose,
          isWin = _state2.isWin;
      ...
      return _react2.default.createElement(
        'div',
        { className: 'maze' },
        [].concat(_toConsumableArray(Array(ROW * COLUMN))).map(function (item, index) {
          return _react2.default.createElement(
            'div',
            { key: index, className: 'square' },
            squares[currentSquareIndex] === index ? _react2.default.createElement('div', { className: 'blue-dot' }) : null
          );
        }),
        !isStart ? _react2.default.createElement(_Button2.default, { onClick: this.start, text: 'B\u1EAFt \u0111\u1EA7u' }) : null,
        isStart && currentQuestion.isShow ? _react2.default.createElement(_Question2.default, {
          resume: this.resume,
          surrender: this.surrender,
          currentQuestion: currentQuestion }) : null,
        isStart && isLose ? _react2.default.createElement(_Button2.default, {
          playAgain: this.playAgain,
          showPlayAgain: true, text: 'Chia bu\u1ED3n, b\u1EA1n \u0111\xE3 thua' }) : null,
        isStart && isWin ? _react2.default.createElement(_Button2.default, {
          playAgain: this.playAgain,
          showPlayAgain: true, text: 'Ch\xFAc m\u1EEBng b\u1EA1n \u0111\xE3 tr\u1EA3 l\u1EDDi \u0111\xFAng h\u1EBFt t\u1EA5t c\u1EA3 c\xE2u h\u1ECFi' }) : null
      );
    }
  }]);
...
_reactDom2.default.render(_react2.default.createElement(MazeHome, null), document.getElementById('maze'));
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!./maze_home.css", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!./maze_home.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var Question = function (_React$Component) {
  ...
  function Question() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Question.__proto__ || Object.getPrototypeOf(Question)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      event.preventDefault();
    }, _this.submitAnswer = function (event) {
      event.preventDefault();
      var selected = _this.state.selected;

      var isWrong = selected.find(function (answer) {
        return !answer.is_correct;
      });
      if (!selected.length || isWrong) {
        return _this.props.surrender();
      }

      _this.props.resume();
    }, _this.onAnswerChange = function (answer) {
  ...
  _createClass(Question, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          surrender = _props.surrender;


      return _react2.default.createElement(
        "div",
        { className: "question", onContextMenu: this.onContextMenu },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "h4",
            null,
            "Ph\u1EA3i tr\u1EA3 l\u1EDDi c\xE2u h\u1ECFi \u0111\u1EC1 ti\u1EBFp t\u1EE5c"
          ),
          _react2.default.createElement(
            "div",
          ...
          _react2.default.createElement(
            ...
            "Danh s\xE1ch \u0111\xE1p \xE1n"
          ),
          currentQuestion.answers.map(function (answer, index) {
            return _react2.default.createElement(
              "div",
              { key: index },
              _react2.default.createElement("input", { onChange: _this2.onAnswerChange(answer), type: "checkbox" }),
              " ",
              answer.content
            );
          }),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "button",
              { className: "button-primary", onClick: this.submitAnswer },
              "Tr\u1EA3 l\u1EDDi"
            ),
            _react2.default.createElement(
              "button",
...
var Button = function Button(_ref) {
  var text = _ref.text,
      ...
      showPlayAgain = _ref.showPlayAgain,
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "button",
      { onClick: onClick, className: "button-primary" },
      text
    ),
    showPlayAgain ? _react2.default.createElement(
      "button",
      { onClick: playAgain, className: "button-primary" },
      "Ch\u01A1i l\u1EA1i"
    ) : null
  );
};
